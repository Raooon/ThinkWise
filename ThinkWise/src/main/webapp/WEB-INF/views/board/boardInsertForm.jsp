         ...
         <div class="col-md-8 mb-5 pb-2">
          ...
          <form action="boardInsert.do" method="post" id="frm" enctype="multipart/form-data">
            <div class="contact_form-container">
                ...
                <div>
                  <textarea rows="10" cols="70" id="contents" name="contents" placeholder="Contents"></textarea>
                </div>
                
                <div>
                  <input type="file" id="firstImage" name="firstImage">
                  <input type="button" onclick="UploadPlus(1)" id="firstBtn" value="+ 추가" class="btn btn-outline-secondary">
                </div>
                
                <div style="display: none" id="UploadSecond">
                  <input type="file" id="secondImage" name="secondImage">
                  <input type="button" onclick="UploadPlus(2)" id="secondBtn" value="+ 추가" class="btn btn-outline-secondary">
                </div>
